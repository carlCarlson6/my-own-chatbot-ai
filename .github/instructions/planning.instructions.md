...
- Every new plan document **must** be created under `docs/plans/`.
...
Example entry:
```md
- [`docs/plans/frontend-chat-ui-plan.md`](docs/plans/frontend-chat-ui-plan.md) — Frontend chat UI: wire send-message flow to live backend.
```
